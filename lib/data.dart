                ...
                children: [
                  Stack(
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.fromLTRB(30, 110, 20, 0),
                        child: Container(
                          height: 90,
                          width: double.infinity,
                          child: Center(
                      ...
                      Center(
                        child: Padding(
                          padding: EdgeInsets.fromLTRB(50, 180, 20, 0),
                          child: Container(
                            height: 90,
                            width: double.infinity,
                            child: Center(
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontSize:
                                      70, // Adjust the font size as needed
                      ...
                      Center(
                        child: Padding(
                          padding: EdgeInsets.fromLTRB(50, 275, 20, 0),
                          child: Container(
                            child: Text(
                      ...
                      Center(
                        child: Padding(
                          padding: EdgeInsets.fromLTRB(50, 305, 20, 0),
                          child: Container(
                            child: Text(
                              ' Wind Degree     -      $deg °',
                              style: TextStyle(
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(30, 3, 3, 4),
